<!-- Notification Banner -->
<div class="fixed top-0 w-full h-16 bg-[#88D040] text-white z-30 shadow-md">
    <div class="text-center">
        <h1 class="md:text-base text-sm font-semibold flex items-center justify-center text-wrap text-black">
            BIG BILLION SALE IS LIVE TODAY OFFER 50% OFF
        </h1>
        <div class="mt-1 flex flex-wrap justify-center gap-1 text-xs text-wrap text-black">
...
<nav class="bg-black lg:p-4 p-1 shadow-md">
    <div class="container mx-auto flex justify-between items-center">
        ...
        <!-- Mobile Menu Button -->
        <div class="md:hidden">
            <button id="navbar-toggle-button" class="toggle-navbar-button text-green-400 hover:text-yellow-300 transition duration-300">
