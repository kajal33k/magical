...
<div class="slide flex flex-col lg:flex-row">
  ...
  <img src="{{asset('asset/img/SLIDE11.jpeg')}}" class="w-full lg:w-1/2 hidden lg:block" alt="Slide 3">
</div>
<div class="slide flex flex-col lg:flex-row">
  <img src="{{asset('asset/img/SLIDE11.jpeg')}}" class="w-full lg:w-1/2" alt="Slide 2">
  <img src="{{asset('asset/img/SLIDE12.jpeg')}}" class="w-full lg:w-1/2 hidden lg:block" alt="Slide 3">
</div>
<div class="slide flex flex-col lg:flex-row">
  <img src="{{asset('asset/img/SLIDE12.jpeg')}}" class="w-full lg:w-1/2" alt="Slide 2">
  <img src="{{asset('asset/img/SLIDE13.jpeg')}}" class="w-full lg:w-1/2 hidden lg:block" alt="Slide 3">
</div>

<div class="slide flex flex-col lg:flex-row">
  <img src="{{asset('asset/img/SLIDE13.jpeg')}}" class="w-full lg:w-1/2" alt="Slide 2">
  <img src="{{asset('asset/img/SLIDE14.jpeg')}}" class="w-full lg:w-1/2 hidden lg:block" alt="Slide 3">
</div>
<div class="slide flex flex-col lg:flex-row">
  <img src="{{asset('asset/img/SLIDE14.jpeg')}}" class="w-full lg:w-1/2" alt="Slide 2">
  <img src="{{asset('asset/img/SLIDE15.jpeg')}}" class="w-full lg:w-1/2 hidden lg:block" alt="Slide 3">
</div>

<div class="slide flex flex-col lg:flex-row">
  <img src="{{asset('asset/img/SLIDE15.jpeg')}}" class="w-full lg:w-1/2" alt="Slide 2">
  <img src="{{asset('asset/img/SLIDE16.kpeg')}}" class="w-full lg:w-1/2 hidden lg:block" alt="Slide 3">
</div>
<div class="slide flex flex-col lg:flex-row">
  <img src="{{asset('asset/img/SLIDE16.jpeg')}}" class="w-full lg:w-1/2" alt="Slide 2">
  <img src="{{asset('asset/img/SLIDE17.jpg')}}" class="w-full lg:w-1/2 hidden lg:block" alt="Slide 3">
</div>

<div class="slide flex flex-col lg:flex-row">
  <img src="{{asset('asset/img/SLIDE17.jpg')}}" class="w-full lg:w-1/2" alt="Slide 2">
  <img src="{{asset('asset/img/SLIDE18.jpg')}}" class="w-full lg:w-1/2 hidden lg:block" alt="Slide 3">
</div>
<div class="slide flex flex-col lg:flex-row">
  <img src="{{asset('asset/img/SLIDE18.jpg')}}" class="w-full lg:w-1/2" alt="Slide 2">
  <img src="{{asset('asset/img/SLIDE19.jpg')}}" class="w-full lg:w-1/2 hidden lg:block" alt="Slide 3">
</div>
...
<div class="container mx-auto px-4 py-10">
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-4">
        <div class="relative m-4 shadow-xl shadow-gray-500 rounded-xl">
            <img src="{{asset('asset/img/sampoo1.png')}}" class="w-full h-full object-cover rounded-2xl" alt="Image 1">
        </div>
        <div class="relative m-4 shadow-xl rounded-xl shadow-gray-500">
            <img src="{{asset('asset/img/sampoo2.jpg')}}" class="w-full h-full object-cover rounded-2xl" alt="Image 2">
        </div>
        <div class="relative m-4 shadow-xl rounded-xl shadow-gray-500">
          <img src="{{asset('asset\img\Post_01[1].jpg')}}" class="w-full h-full object-cover rounded-2xl" alt="Image 2">
      </div>
      <div class="relative m-4 shadow-xl rounded-xl shadow-gray-500">
        <img src="{{asset('asset\img\Post 02.jpg')}}" class="w-full h-full object-cover rounded-2xl" alt="Image 2">
    </div>
    <div class="relative m-4 shadow-xl rounded-xl shadow-gray-500">
      <img src="{{asset('asset\img\Post 03.jpg')}}" class="w-full h-full object-cover rounded-2xl" alt="Image 2">
  </div>
  <div class="relative m-4 shadow-xl rounded-xl shadow-gray-500">
    <img src="{{asset('asset\img\post 04 - Copy.jpg')}}" class="w-full h-full object-cover rounded-2xl" alt="Image 2">
</div>
        <div class="relative m-4 shadow-xl rounded-xl shadow-gray-500">
            <img src="{{asset('asset/img/sampoo3.png')}}" class="w-full h-full object-cover rounded-2xl" alt="Image 3">
        </div>
        <div class="relative m-4 shadow-xl rounded-xl shadow-gray-500">
            <img src="{{asset('asset/img/sampoo4.png')}}" class="w-full h-full object-cover rounded-2xl" alt="Image 4">
        </div>
        <div class="relative m-4 shadow-xl rounded-xl shadow-gray-500">
            <img src="{{asset('asset/img/sampoo5.png')}}" class="w-full h-full object-cover rounded-2xl" alt="Image 5">
        </div>
        <div class="relative m-4 shadow-xl rounded-xl shadow-gray-500">
            <img src="{{asset('asset/img/sampoo6.png')}}" class="w-full h-full object-cover rounded-2xl" alt="Image 6">
        </div>
    </div>
</div>
...
<div class="container mx-auto px-4 py-10">
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-4">
        <div class="relative m-4 shadow-xl rounded-xl shadow-gray-500">
            <img src="{{asset('asset/img/serum1.jpeg')}}" class="w-full h-full object-cover rounded-2xl" alt="Image 1">
        </div>
        <div class="relative m-4 shadow-xl rounded-xl shadow-gray-500">
            <img src="{{asset('asset/img/serum2.jpeg')}}" class="w-full h-full object-cover rounded-2xl" alt="Image 2">
        </div>
        <div class="relative m-4 shadow-xl rounded-xl shadow-gray-500">
            <img src="{{asset('asset/img/serum3.jpeg')}}" class="w-full h-full object-cover rounded-2xl" alt="Image 3">
        </div>
        <div class="relative m-4 shadow-xl rounded-xl shadow-gray-500">
            <img src="{{asset('asset/img/serum4.jpeg')}}" class="w-full h-full object-cover rounded-2xl" alt="Image 4">
        </div>
        <div class="relative m-4 shadow-xl rounded-xl shadow-gray-500">
            <img src="{{asset('asset/img/serum5.jpeg')}}" class="w-full h-full object-cover rounded-2xl" alt="Image 5">
        </div>
        <div class="relative m-4 shadow-xl rounded-xl shadow-gray-500">
            <img src="{{asset('asset/img/serum6.jpeg')}}" class="w-full h-full object-cover rounded-2xl" alt="Image 6">
        </div>
    </div>
</div>
  ...
  {{-- icon --}}
          ...
          <div class="flex space-x-4">
            <div class="rounded-full shadow-md w-12 h-12 flex items-center justify-center hover:bg-gray-200">
              <a href="https://www.facebook.com"><i class="ri-facebook-line text-green-800 text-2xl"></i></a>
            </div>
            <div class="rounded-full shadow-md w-12 h-12 flex items-center justify-center hover:bg-gray-200">
              <a href="https://www.instagram.com"><i class="ri-instagram-line text-green-800 text-2xl"></i></a>
            </div>
          </div>
        </div>
          ...
          <form action="{{route('appointment.store')}}" method="POST">
            ...
            <div class="grid grid-cols-1 gap-4 mb-4">
              ...
              <div>
                ...
                <input type="text" id="number" name="number" class="form-input w-full p-3 bg-gray-300" required>
              </div>
              <div>
...
<footer class="bg-green-800 py-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div class="sec3">
          ...
          <div class="grid grid-cols-2 gap-2">
            <img src="{{asset('asset/img/product1.jpg')}}" alt="" class="w-full h-24 object-cover rounded-lg shadow-md">
            <img src="{{asset('asset/img/product2.jpg')}}" alt="" class="w-full h-24 object-cover rounded-lg shadow-md">
            <img src="{{asset('asset/img/product3.jpg')}}" alt="" class="w-full h-24 object-cover rounded-lg shadow-md">
            <img src="{{asset('asset/img/product4.png')}}" alt="" class="w-full h-24 object-cover rounded-lg shadow-md">
          </div>
        </div>
        <!-- Section 4 -->
        <div class="sec4">
  ...
  <div id="floatingButton" class="fixed bottom-4 right-4">
    <button id="toggleButton" class="bg-green-500 hover:bg-green-600 text-white p-3 rounded-full shadow-lg focus:outline-none transition-colors duration-300">
    ...
    <div id="iconPanel" class="hidden bg-white rounded-lg shadow-lg p-4 mt-2 transition-all duration-300">
      <a href="tel:+916388337746" class="block mb-2">
        <button class="w-full p-3 rounded-full bg-green-500 hover:bg-green-600 text-white flex items-center justify-center focus:outline-none transition-colors duration-300">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    document.addEventListener('click', function(event) {
      const isClickInside = toggleButton.contains(event.target) || iconPanel.contains(event.target);
