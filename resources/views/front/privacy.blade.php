...
<section class="mb-5 p-6 bg-gray-100 rounded-lg shadow-md">
    ...
    <section class="mb-8 p-8 bg-gray-100 rounded-lg shadow-md border border-gray-300">
       
        <h3 class="text-xl font-semibold text-gray-700 mt-8">Grievance Officer</h3>
