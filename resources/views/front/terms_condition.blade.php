...
@section('content')
    <div class="container py-10 px-6 mx-auto max-w-4xl md:mt-24 mt-8">
        ...
        <p class="text-gray-700 leading-relaxed bg-gray-100 p-4 rounded-lg shadow-md">
            ...
            any physical or digital signatures. <strong>This document is an electronic record</strong> in terms of the
        ...
        <section class="mb-5 p-6 bg-gray-100 rounded-lg shadow-md">
            ...
            <p class="text-gray-700 leading-relaxed">
                ...
                and Terms of Use for access or usage of domain name https://magicalbrands.info/ ('Website'), including the
                related mobile site and mobile application (hereinafter referred to as 'Platform').

            </p>
            <p class="text-gray-700 mt-3">
                The Platform is owned by MM ENTERPRISES, a company incorporated under the Companies Act, 1956 with its
                registered office at RZ A 139 OLD PLOT NO 138 GALI NO1 SITAPURI PART 1 New Delhi (hereinafter referred to as
