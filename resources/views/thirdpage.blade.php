    ...
    <div
        ...
        <div class="right bg-white p-2 lg:pl-32 w-full">
            ...
            <div class="text-center space-y-4">
                <h1 class="text-md md:text-3xl font-bold"> Brands  Hair shampoo (Ammonia Free) Hurry up 30% of offer
                   </h1>
                ...
                <p class="text-green-600 text-xl font-bold"> <strike class="text-red-600 px-1"> Rs. 699.00 </strike> 499.00
                </p>
